...
#'
#' @param trueout Logical value indicating whether the true event times should
#' also be returned. Default is \code{FALSE}.
#'
#' @return A data frame or list containing the simulated semi-competing risks data.
#' @export
