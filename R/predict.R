...
#'  c("msurv","jsurv","csurv","chr")
#'  \code{"msurv"} for marginal survival function,  \code{"jsurv"} for joint survival function, \code{"csurv"} for conditional survival function and \code{"chr"} for cross-hazard ratio function
#' @param t1 numeric vector. See \code{\link{predictscr}}.
#' @param t2 numeric vector. See \code{\link{predictscr}}.
#' @param s2 numeric vector. See \code{\link{predictscr}}.
#' @param t1equal A logical value. See \code{\link{predictscr}}.
#' @param bystrata A logical value. If TRUE, return the stratified functions.
...
#'
#'
#' @param object An object of class "mscr".
...
#' \code{"qrl"} for the quantile residual lifetime, and \code{"qst"} for the
#' quantile survival time, calculated as the quantile residual lifetime plus
#' the landmark time.
...
#' @param ... other arguments
#' @return A list containing prediction results. The returned components depend
#'   on \code{type}, including predicted survival probabilities, restricted
