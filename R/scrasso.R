...
#' @param model Logical. If \code{TRUE}, the output includes \code{data}.
...
#' Default is \code{b=0}. When both \code{a=0} and \code{b=0}, the weight function \eqn{w = 1},
...
#' }
#'
#' @details See details in Lakhal et al. (2008) and Yu et al. (2026)'s supplementary materials.
#'
